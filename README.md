...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mrc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15153&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mrc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mrc` can be installed with:

```
conda install mrc
```

It is possible to list all of the versions of `mrc` available on your platform with:
